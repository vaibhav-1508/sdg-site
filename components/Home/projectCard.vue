<template>
  <div class="wrapper relative rounded-xl">
    <div class="">
      <div class="
        "></div>
      <div class="
        ...
        ">
        <nuxt-img class="max-w-20vh imgrounded-lg " :src="imgAddress" alt="ProjectImg" loading="lazy" />
        <div class="
            info
            px-10
            w-full
          ...
          <span v-if="project.tech" class="contentHeading text-sm ">
            Technologies Used</span>
          <ul class="techList list-none text-sm text-left">
